...
// Gửi yêu cầu hủy booking (cho Customer)
...
// Admin phê duyệt yêu cầu thay đổi/hủy booking
router.put('/bookingChangeRequests/:id/approve', protect, authorize('Admin'), approveBookingChangeRequest);
// Admin từ chối yêu cầu thay đổi/hủy booking
router.put('/bookingChangeRequests/:id/disapprove', protect, authorize('Admin'), disapproveBookingChangeRequest);
